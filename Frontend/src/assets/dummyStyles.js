...
export const homeCarsStyles = {
  ...
  priceBadge: "absolute top-4 right-4 z-20 bg-gray-900/80 backdrop-blur-md text-white px-3 py-1.5 rounded-full font-bold text-sm shadow-lg flex items-center",
...
export const carDetailStyles = {
  ...
  carPrice: "text-xl sm:text-2xl md:text-3xl font-bold text-green-400 inline-block",
  pricePerDay: "text-base sm:text-lg font-normal text-gray-400 inline-block ml-1",
...
export const carPageStyles = {
  ...
  glowEffect: "absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none bg-gradient-to-br from-orange-500/20 via-transparent to-blue-500/20",
  ...
  priceBadge: "absolute top-3 left-3 bg-orange-500 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-xl z-10",
